...
const booking = {
    getAllData: () => {
        return new Promise((resolve, reject) => {
            db.query(`SELECT idbooking, users.idusers, email,phone, username, city, address, 
    ...
    getDetail: (id) => {
        return new Promise((resolve, reject) => {
            db.query(`SELECT idbooking, users.idusers, email,phone, username, city, address,users.image as imageusers,
    ...
    insert: (data) => {
        return new Promise((resolve, reject) => {
            db.query(`INSERT INTO booking (idusers, idflight, title, fullname, nationality,payment_status, 
                terminal, gate, total) VALUES ('${data.idusers}', '${data.idflight}',
                '${data.title}','${data.fullname}','${data.nationality}','${data.insurance}',
                '${data.payment_status}','${data.terminal}','${data.gate}','${data.total}')`, (err, result) => {
                if (err) {
                    reject(new Error(err))
                } else {
                    resolve(result)
